...
// Scroll to Bottom
const conversationDiscussion = document.querySelector(".discussion__box");
if (conversationDiscussion) conversationDiscussion.scrollTop = conversationDiscussion.scrollHeight;
